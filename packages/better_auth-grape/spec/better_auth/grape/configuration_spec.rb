...
RSpec.describe BetterAuth::Grape do
  after do
    described_class.reset!
  end

  it "builds a memoized core auth instance from Grape configuration" do
  ...
  it "generates a default config template that supports env aliases" do
  ...
  def secret
    "grape-secret-that-is-long-enough-for-validation"
  end
end

...
Gem::Specification.new do |spec|
  spec.name = "openauth-saml"
  spec.version = "0.10.0"
  spec.authors = ["Sebastian Sala"]
  spec.email = ["sebastian.sala.tech@gmail.com"]

  spec.summary = "Alias package for better_auth-saml"
  spec.description = "OpenAuth SAML alias package that installs better_auth-saml."
  ...
  spec.add_dependency "better_auth-saml", "0.10.0"
end
